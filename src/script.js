...
const door2ColorTexture = textureLoader.load("/textures/door3/color.jpg");
const door2AplhaTexture = textureLoader.load("/textures/door/alpha.jpg");
const door2AmbientOcclusionTexture = textureLoader.load(
  "/textures/door3/ambientOcclusion.jpg"
);
const door2HeightTexture = textureLoader.load("/textures/door3/height.png");
const door2NormalTexture = textureLoader.load("/textures/door3/normal.jpg");
const door2MetalnessTexture = textureLoader.load(
  "/textures/door3/metalness.jpg"
);
const door2RoughnessTexture = textureLoader.load(
  "/textures/door3/roughness.jpg"
);

// Candle Texture
const candleColorTexture = textureLoader.load("/textures/candle/color.jpg");
const candleAmbientOcclusionTexture = textureLoader.load(
  "/textures/candle/ambientOcclusion.jpg"
);
const candleHeightTexture = textureLoader.load("/textures/candle/height.png");
const candleNormalTexture = textureLoader.load("/textures/candle/normal.jpg");
const candleRoughnessTexture = textureLoader.load(
  "/textures/candle/roughness.jpg"
);
...
const moonRoughnessTexture = textureLoader.load("/textures/moon/roughness.jpg");
...
// Mud Texture
// const mudColorTexture = textureLoader.load("/textures/mud/color.jpg");
// const mudAmbientOcclusionTexture = textureLoader.load(
//   "/textures/mud/ambientOcclusion.jpg"
// );
// const mudNormalTexture = textureLoader.load("/textures/mud/normal.jpg");
// const mudRoughnessTexture = textureLoader.load("/textures/mud/roughness.jpg");
// const mudHeightTexture = textureLoader.load("/textures/mud/height.png");
...
const pillarRight2 = new THREE.Mesh(pillarGeometry2, pillarMaterial);
pillarRight.position.y = 3.5 / 2;
pillarRight.position.x = 8 / 2;
pillarRight.position.z = 4 / 2;

pillarRight2.position.y = 5 / 2;
pillarRight2.position.x = 7 / 2;
pillarRight2.position.z = 1;

const pillarLeft = new THREE.Mesh(pillarGeometry, pillarMaterial);
const pillarLeft2 = new THREE.Mesh(pillarGeometry2, pillarMaterial);
pillarLeft.position.y = 3.5 / 2;
pillarLeft.position.x = -8 / 2;
pillarLeft.position.z = 4 / 2;

pillarLeft2.position.y = 5 / 2;
pillarLeft2.position.x = -7.5 / 2;
pillarLeft2.position.z = 1;

house.add(pillarLeft, pillarRight, pillarLeft2, pillarRight2);

// Pillar roof
const pillarRoofGeometry = new THREE.ConeGeometry(1, 1.5, 32);
const pillarRoofGeometry2 = new THREE.ConeGeometry(1, 1.8, 32);
...
const pillarRoof3 = new THREE.Mesh(pillarRoofGeometry2, pillarRoofMaterial);
const pillarRoof4 = new THREE.Mesh(pillarRoofGeometry2, pillarRoofMaterial);

pillarRoof1.position.y = 4;
pillarRoof1.position.z = 4 / 2;
pillarRoof1.position.x = 8 / 2;

pillarRoof3.position.y = 6;
pillarRoof3.position.z = 1;
pillarRoof3.position.x = 7 / 2;

pillarRoof2.position.y = 4;
pillarRoof2.position.z = 4 / 2;
pillarRoof2.position.x = -8 / 2;

pillarRoof4.position.y = 6;
pillarRoof4.position.z = 1;
pillarRoof4.position.x = -7.5 / 2;

house.add(pillarRoof1, pillarRoof2, pillarRoof3, pillarRoof4);

// Create roof
let roofGeometry = new THREE.CylinderGeometry(
  0.4 / Math.sqrt(2),
  0.8 / Math.sqrt(2),
  0.8,
  4,
...
//   new THREE.ConeGeometry(3.5, 3, 10),
...
const door = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    map: door2ColorTexture,
    transparent: true,
    alphaMap: door2AplhaTexture,
    aoMap: door2AmbientOcclusionTexture,
    displacementMap: door2HeightTexture,
    displacementScale: 0.2,
    normalMap: door2NormalTexture,
    metalnessMap: door2MetalnessTexture,
    roughnessMap: door2RoughnessTexture,
  })
);
...
const candleMaterial = new THREE.MeshStandardMaterial({
  map: candleColorTexture,
  aoMap: candleAmbientOcclusionTexture,
  displacementMap: candleHeightTexture,
  displacementScale: 0.1,
  normalMap: candleNormalTexture,
  roughnessMap: candleRoughnessTexture,
});
...
const candleLight = new THREE.PointLight("#561a69", 8, 6);
candleLight.position.set(0, 8, 3);
scene.add(candleLight)

// Mud Pathches
// const mudGeometry = new THREE.CircleGeometry(1, 15);
// const mudMaterial = new THREE.MeshStandardMaterial({
//   map: mudColorTexture,
//   aoMap: mudAmbientOcclusionTexture,
//   displacementMap: mudHeightTexture,
